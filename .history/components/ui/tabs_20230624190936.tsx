...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-lg shadow-md bg-zinc-200 p-1 px-1.5 text-gray-600 dark:bg-slate-800 dark:text-slate-400",
      className
    )}
    {...props}
  />

    ...
    <header>
      <div className="flex flex-col md:flex-row items-center p-6 xl:p-10 xl:px-24 bg-gray-500/10">
        ...
        <div className="flex items-center gap-3 flex-1 justify-end w-full">
          <form className="peer flex items-center justify-center  flex-1 md:flex-initial">
            <div className="relative  flex-1 md:flex-initial">
              <span className="absolute inset-y-0 left-0 flex items-center pl-3 peer-focus:text-gray-800">
                <HiMagnifyingGlass className="peer-focus:text-gray-500 w-6 h-6 text-gray-400" />
              </span>
              <div className="flex gap-3 h-full">
                <input
                  type="text"
                  className="peer w-full flex-1 h-full py-2.5 pl-10 pr-4 border shadow-sm focus-visible:outline-none focus-visible:ring-1 focus:ring-gray-400 text-black bg-white border-gray-200 text-sm rounded-md hover:border-gray-300 placeholder:text-gray-400 focus:placeholder:text-gray-500"
                  placeholder="Search"
                />

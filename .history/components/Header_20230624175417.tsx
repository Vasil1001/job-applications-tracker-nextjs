          ...
          <form className=" flex items-center justify-center  flex-1 md:flex-initial">
            <div className="relative  flex-1 md:flex-initial">
              ...
              <div className="flex gap-3 h-full">
                <input
                  type="text"
                  className="w-full flex-1 h-full py-2.5 pl-10 pr-4 border shadow-sm focus-visible:outline-none focus-visible:ring-1 focus:ring-gray-400 text-black bg-white border-gray-200 text-sm rounded-md hover:border-gray-350 placeholder:text-gray-400 focus:placeholder:text-gray-500"
                  placeholder="Search"
                />

            ...
            <div className="relative  flex-1 md:flex-initial">
              ...
              <div className="flex gap-3 h-full">
                <input
                  ...
                  placeholder="Search"
                />
                <div className="border flex px-2.5 items-center justify-center shadow-sm focus-visible:outline-none focus-visible:ring-1 focus:ring-gray-400 text-black bg-white text-gray-400 border-gray-200 text-sm rounded-md hover:border-gray-300">
                  VD
                </div>
              </div>
            </div>

...
export default function Header() {
  return (
    <header>
      ...
      <form className="flex items-center space-x-5 bg-white rounded-md  shadow-md border border-gray-300 flex-1 md:flex-initial">
        <HiMagnifyingGlass className="w-6 h-6 text-gray-400" />
        <input type="text" placeholder="search" className="flex-1 outline-none p-3 "/>

  ...
  return (
    <header>
      <div className="flex flex-col md:flex-row items-center p-5 xl:p-10 xl:px-24 bg-gray-500/10">
        ...
        <div className="relative flex bg-red-400 items-center gap-3 flex-1 justify-end w-full">
          <form className="">
          ...
          <button className="flex-initial p-2 px-3 text-black text-sm font-regular border focus-visible:outline-none focus-visible:ring-1 focus:ring-gray-400 bg-white border-gray-200 sm:text-sm rounded-md hover:border-gray-300 ">
            VD
          </button>
        </div>

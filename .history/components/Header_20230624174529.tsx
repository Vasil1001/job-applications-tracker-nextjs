          ...
          <form className=" flex items-center justify-center  flex-1 md:flex-initial">
            <div className="relative  ">
              ...
              <input
                ...
                placeholder="Search"
              />
               <div className="p-2 px-3 text-black text-sm font-regular border outline-none focus-visible:outline-none focus-visible:ring-1 focus:ring-gray-400 bg-white border-gray-200 text-sm rounded-md hover:border-gray-300 ">
            VD
          </div>
            </div>

...
export default function Header() {
  return (
    <header>
      <div className="flex flex-col md:flex-row items-center  xl:p-10 xl:px-24 bg-gray-500/10">
        {/* <Navbar /> */}
        {/* <Image
        ...
        <div className="flex items-center font-bold text-3xl mb-4">
          ...
          <button className="ml-3 py-2 px-3 flex-initial text-black text-sm font-regular border focus-visible:outline-none focus-visible:ring-1 focus:ring-gray-400 bg-white border-gray-200 sm:text-sm rounded-md hover:border-gray-300 ">
              VD
            </button> 
        </div>

        {/* Search input, button and profile */}
        <div className="flex items-center gap-3 bg-red-400 flex-1">

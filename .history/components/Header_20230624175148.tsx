          ...
          <form className=" flex items-center justify-center  flex-1 md:flex-initial">
            ...
            <div className="flex gap-3">
              <input
                ...
                placeholder="Search"
              />
              <div className="border px-2.5 text-center items-center contect-center mx-auto shadow-sm focus-visible:outline-none focus-visible:ring-1 focus:ring-gray-400 text-black bg-white border-gray-200 text-sm rounded-md hover:border-gray-300">VD</div>
              </div>
            </div>

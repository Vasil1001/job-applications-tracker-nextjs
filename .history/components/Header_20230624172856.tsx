    ...
    <header>
      <div className="flex flex-col md:flex-row items-center p-5 xl:p-10 xl:px-24 bg-gray-500/10">
        ...
        <div className="flex bg-red-400 items-center gap-3 flex-1 justify-end w-full">
          <form className="peer flex items-center space-l-5 bg-white p-1 border shadow-sm focus-visible:outline-none focus-visible:ring-1 focus:ring-gray-400 text-black border-gray-200 sm:text-sm rounded-md hover:border-gray-300 placeholder:text-gray-400 focus:placeholder:text-gray-500 flex-1 md:flex-initial">
          ...
          <button className="min-h-full  flex-initial text-black text-sm font-regular border focus-visible:outline-none focus-visible:ring-1 focus:ring-gray-400 bg-white border-gray-200 sm:text-sm rounded-md hover:border-gray-300 ">
            VD
          </button>
        </div>

      ...
      <div className="flex justify-between">
        ...
        <div className="flex gap-3">
          <div className="relative">
            ...
            <input
              type="text"
              className="w-full py-2 pl-10 pr-4 text-black bg-white border border-gray-200 sm:text-sm rounded-md focus:border-gray-300 focus:ring hover:border-gray-300 placeholder:text-gray-400 "
              placeholder="Search"
            />
          </div>

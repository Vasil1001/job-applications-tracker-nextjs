    ...
    <header>
      <div className="flex flex-col md:flex-row items-center p-5 xl:p-10 xl:px-24 bg-gray-500/10">
        ...
        <div className="flex items-center gap-3 flex-1 justify-end w-full">
          <form className=" flex items-center p-1 space-l-6 bg-white border shadow-sm focus-visible:outline-none focus-visible:ring-1 focus:ring-gray-400 text-black border-gray-200 text-sm rounded-md hover:border-gray-300 placeholder:text-gray-400 focus:placeholder:text-gray-500 flex-1 md:flex-initial">

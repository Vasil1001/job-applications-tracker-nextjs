    ...
    <header>
      <div className="flex justify-between">
        ...
        <div className="flex items-center font-bold text-3xl">
          ...
          <span className="text-gray-700 hidden md:block">Job Tracker</span>
        </div>
      ...
      <form className="mt-4 flex items-center space-x-5 bg-white rounded-md p-2 shadow-sm border border-gray-200 flex-1 md:flex-initial">

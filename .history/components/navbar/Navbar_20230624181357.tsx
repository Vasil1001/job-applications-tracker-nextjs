...
export default function Navbar() {
  return (
    <div className="flex flex-col bg-gray-500/10 items-center  p-6 xl:px-24 transition-all ">
      ...
      <div className="flex w-full flex-1 items-center justify-center md:justify-start mt-3 pb-5">
          <p className="flex items-center text-sm font-light pr-5 shadow-sm rounded-md p-5 w-fit bg-white italic border border-gray-300 hover:border-gray-300">

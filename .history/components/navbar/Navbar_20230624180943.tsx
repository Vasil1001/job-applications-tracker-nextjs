...
export default function Navbar() {
  return (
    <div className="bg-gray-500/10">
      <div className="flex flex-col md:flex-row items-center p-6 xl:px-24  transition-all">
        {/* <Navbar /> */}
        {/* <Image
      ...
      <div className="flex w-full flex-1 items-center justify-center px-5 md:py-5">
          <p className="flex items-center text-sm font-light pr-5 shadow-sm rounded-md p-5 w-fit bg-white italic border border-gray-300 text-sm rounded-md hover:border-gray-300">

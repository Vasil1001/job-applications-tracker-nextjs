  ...
  return (
    <div className="bg-gray-500/10  p-6 xl:px-24 transition-all ">
      ...
      <div className="flex w-full flex-1 items-center justify-center md:justify-start mt-3 pb-5">
          <p className="flex items-center text-sm font-light pr-5 shadow-sm rounded-md p-5  bg-white italic border border-gray-300 rounded-md hover:border-gray-300">

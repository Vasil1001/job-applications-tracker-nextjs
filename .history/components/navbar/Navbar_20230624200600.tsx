  ...
  return (
    <div className="px-7 pt-7 xl:px-24 transition-all ">
      ...
      <div className="xl:w-7/12 mx-auto">
        ...
        /> */}
          {/* Logo */}
          <div className="flex items-center font-bold text-3xl hover:p-3 hover:transition-all delay-150 duration-300 ease-in-out hover:translate-x-1 hover:scale-105 hover:bg-zinc-300 hover:rounded-lg  mb-3 md:mb-0">

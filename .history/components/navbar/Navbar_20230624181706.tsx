...
export default function Navbar() {
  return (
    <div className="bg-gray-500/10  p-6 xl:px-24 transition-all ">
      <div className="flex flex-col md:flex-row items-center transition-all xl:w-7/12 mx-auto">
        {/* <Navbar /> */}
        {/* <Image
      ...
      <div className="flex w-full flex-1  md:justify-start mt-3 pb-5">
          <p className="flex flex-1 items-center text-sm font-light pr-5 shadow-sm rounded-md p-5 w-fit bg-white italic border border-gray-300 hover:border-gray-300">

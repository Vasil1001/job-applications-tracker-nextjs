  ...
  return (
    <div className="px-7 pt-7 xl:px-24 transition-all ">
      ...
      <div className="xl:w-7/12 mx-auto">
        ...
        /> */}
          {/* Logo */}
          <div className="flex items-center font-bold text-3xl hover:p-2 hover:pl-4 hover:transition-all delay-150 duration-300 ease-in-out hover:border hover:border-gray-300 hover:bg-zinc-200 hover:rounded-lg  mb-3 md:mb-0">
